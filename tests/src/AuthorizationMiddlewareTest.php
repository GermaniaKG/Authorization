 ...
 */
class AuthorizationMiddlewareTest extends \PHPUnit\Framework\TestCase
{

    /**
     * @dataProvider provideData
     */
    public function testInstantiation( $auth_result, $url, $expected_status_code) : AuthorizationMiddleware
    {
